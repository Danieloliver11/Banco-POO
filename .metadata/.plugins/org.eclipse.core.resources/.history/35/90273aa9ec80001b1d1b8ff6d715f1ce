...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println("[BANCO GEAR]\nVenha fazer parte dessa engrenagem, venha para Gear!\n");
			...
			if (question1 == '1') {
				for (contador = 1; contador < 10; contador++) {
					...
					if (cp.getNumero() == numero && cp.getCpf().equalsIgnoreCase(cpf)) {
						System.out.println();
						System.out.println("__[BANCO GEAR]__\n__Venha fazer parte dessa engrenagem, venha para Gear!__");
			...
			if (question1 == '2') {
				while (cont != 'N') {
					...
					System.out.println(pessoa.getMovimento()+" MOVIMENTOS da CONTA CORRENTE ");
